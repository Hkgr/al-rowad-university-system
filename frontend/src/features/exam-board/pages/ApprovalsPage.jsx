...
function StatusBadge({ status }) {
  ...
  return <span className={`inline-flex rounded-full px-2.5 py-1 font-bold ${item?.style ?? 'bg-slate-100 text-slate-700'}`}>{item?.label ?? valueText(status)}</span>
}
