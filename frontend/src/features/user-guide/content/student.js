      ...
      tasks: [
        {
          ...
          flows: [{
            ...
            nodes: [
              ...
              node('register', 'action', 'تأجيل النظري أو التسجيل في التكميلي', 'تؤجل النظري أثناء الإعلان، ثم تسجّل في المواد المؤهلة عندما يفتح مكتب التسجيل الفترة، ويمكنك الإلغاء ما دامت الفترة مفتوحة.'),
              node('grading', 'review', 'التصحيح والمراجعة', 'يصحح الأستاذ المكلّف ثم يراجع موظف الامتحانات ويعتمد أو يعيد الدفعة للتصحيح.'),
              node('published', 'other', 'نشر النتيجة من هيئة الامتحانات', 'تظهر لك النتيجة المنشورة قبل تحديث السجل الرسمي.'),
              node('official', 'end', 'ترحيل النتيجة إلى السجل الرسمي', 'تُرحّل هيئة الامتحانات النتيجة، فتظهر في كشف الدرجات الرسمي.'),
            ],
          }],
          sources: [
