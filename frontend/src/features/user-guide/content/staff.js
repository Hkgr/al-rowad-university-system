      ...
      tasks: [
        {
          ...
          summary: 'سجل للقراءة فقط لأحداث التدقيق ومحاولات الدخول والخروج، مع البحث والتصفية بالوحدة والإجراء والمنفّذ والفترة. لا يعرض كلمات المرور أو التوكنات، ويُظهر البريد مقنّعًا.',
          access: ACCESS.technicalActivity,
          link: { to: '/technical/activity' },
          steps: [
            step('افتح «سجل النشاط»؛ الأحداث مرتبة من الأحدث.'),
            step('ابحث باسم مستخدم المنفّذ أو الحساب المتأثر أو اسم الإجراء أو عنوان IP، أو صفِّ حسب الوحدة والإجراء والمنفّذ والفترة. البحث لا يشمل البريد الإلكتروني ولا نص تفاصيل الحدث.'),
            step('اضغط زر العرض لتفاصيل الحدث: الحقول الآمنة والقيم السابقة والجديدة (البريد مقنّع). الأحداث القديمة غير المنظّمة تظهر برسالة «التفاصيل غير متاحة» دون نصها. اسم الحساب المتأثر رابط إلى تفاصيله.'),
          ],
          sources: [
