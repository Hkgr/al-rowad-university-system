  ...
  return (
    <>
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3" dir="rtl">
        <div>
          <h2 className="text-[20px] font-black text-text-dark mb-[3px]">ÙƒØ´Ù Ø§Ù„Ø¯Ø±Ø¬Ø§Øª</h2>
          <p className="text-[12.5px] text-text-light">{terms.length} ÙØµÙ„ Ø¯Ø±Ø§Ø³ÙŠ</p>
        </div>
        {cgpa && (
          <div className="flex items-center gap-3 bg-primary/[0.05] border border-primary/15 rounded-[12px] px-5 py-2.5" dir="rtl">
            <span className="text-[11px] text-text-light font-medium">Ø§Ù„Ù…Ø¹Ø¯Ù„ Ø§Ù„ØªØ±Ø§ÙƒÙ…ÙŠ</span>
      ...
      {terms.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 gap-2">
          ...
          <p className="text-[14px] font-semibold text-text-light" dir="rtl">Ù„Ø§ ØªÙˆØ¬Ø¯ Ø¨ÙŠØ§Ù†Ø§Øª Ø¯Ø±Ø§Ø³ÙŠØ© Ø¨Ø¹Ø¯</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between px-5 py-3.5 bg-primary/[0.05] border-b border-primary/10" dir="rtl">
                  ...
                  <span className="text-[12px] text-text-light font-medium">{termHours} Ø³Ø§Ø¹Ø©</span>
                </div>
