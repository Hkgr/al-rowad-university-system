...
import AdministrativeAssignmentOverview from './AdministrativeAssignmentOverview'
...
export default function VicePresidentShell({ office }) {
  ...
  return (
    <div className="flex flex-col gap-5 py-8 px-2" dir="rtl">
      ...
      {office === 'administrative' && hasRole(ROLES.vicePresidentAdministrative, identity)
        && hasAssignedPermission(PERMISSIONS.teachingAssignmentsReviewAdministrative, identity)
        && hasActualUniversityScope(identity) && <AdministrativeAssignmentOverview />}
