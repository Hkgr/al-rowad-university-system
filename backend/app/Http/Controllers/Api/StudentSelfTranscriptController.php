...
class StudentSelfTranscriptController extends Controller
{
    ...
    public function show(Request $request): JsonResponse
    {
        ...
        return $this->successResponse($this->grades->getTranscript($student));
    }
    ...
    private function authenticatedStudent(Request $request): Student
    {
        ...
        if ($user === null || $user->student_id === null) {
            throw new AccessDeniedHttpException('يجب أن يكون للحساب سجل طالب لعرض كشف الدرجات.');
        }
