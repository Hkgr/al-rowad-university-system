...
class MinistryPlacementRecordResource extends JsonResource
{
    ...
    {
        return [
            'placement_record_id' => $this->placement_record_id,
            ...
            'matched_academic_program_id' => $this->matched_academic_program_id,
            'track' => $this->track,
            ...
            'matched_academic_program' => $this->whenLoaded('matchedAcademicProgram'),
