...
class BulkPrepareDeanRegistrationOfferingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'program_course_ids' => ['sometimes', 'prohibited_unless:mode,'.self::MODE_SELECTED, 'array'],
            'program_course_ids.*' => ['integer', 'min:1'],
            'minimum_enrollments' => ['sometimes', 'array'],
            'minimum_enrollments.*' => ['nullable', 'integer', 'min:1'],
